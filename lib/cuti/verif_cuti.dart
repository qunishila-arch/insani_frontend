...
class _VerifCutiPageState extends State<VerifCutiPage> {
  ...
  Future<void> fetchCuti() async {
    try {
      final res = await http.get(
        Uri.parse(
          "http://192.168.43.87/insani/API/cuti.php?action=list_atasan&kd_peg=${widget.kdPeg}",
        ),
      );
  ...
  Future<void> verifCuti(String idCuti, String status) async {
    await http.post(
      Uri.parse(
        "http://192.168.43.87/insani/API/cuti.php?action=verif",
      ),
      body: {
        "id": idCuti,
        "status": status,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Tanggal   : ${c['tgl_mulai']} - ${c['tgl_selesai']}"),
